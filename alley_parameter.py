...
if active_cam is None:
    raise ValueError("错误：在该 .blend 场景中没有找到任何相机！请检查原文件。")
...
create_camera_array(
    rows=2,
    cols=3,
    focal_length=34,   # 可修改为需要的焦距
    resolution=(1024, 1024), 
    gap_mm=37.5,    # 可修改为需要的基线
    center_location=dyn_location,    # 可修改为需要的位置
    center_rotation=dyn_rotation     # 可修改为需要的位置
)
# ======================================================================
